...
public class JEUtilsTest extends AppEngineTestCase {
    ...
    public void testConvertBigDecimalToIndexKey() {
        ...
        // 0.1 > 0.01
        final String key0_1 =
            JEUtils.i.convertBigDecimalToIndexKey(new BigDecimal(0.1));
        final String key0_01 =
            JEUtils.i.convertBigDecimalToIndexKey(new BigDecimal(0.01));
        assertTrue("comparing: " + key0_1 + ", " + key0_01, key0_1
            .compareTo(key0_01) >= 1);

        // 100 > 1
        final String key100 =
            JEUtils.i.convertBigDecimalToIndexKey(new BigDecimal(100));
        final String key1 =
            JEUtils.i.convertBigDecimalToIndexKey(new BigDecimal(1));
        assertTrue(
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            bdMap.put(randBd, i);
            strMap.put(JEUtils.i.convertBigDecimalToIndexKey(randBd), i);
        }
    ...
    public void testGenerateUUID() {
        ...
        for (int i = 0; i < 100000; i++) {
            final String uuid = JEUtils.i.generateUUID();
