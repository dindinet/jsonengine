...
public final class JEDocMeta extends org.slim3.datastore.ModelMeta<com.jsonengine.model.JEDoc> {
    ...
    /** */
    protected final org.slim3.datastore.UnindexedAttributeMeta<com.jsonengine.model.JEDoc, java.util.Map<java.lang.String,java.lang.Object>> docValues = new org.slim3.datastore.UnindexedAttributeMeta<com.jsonengine.model.JEDoc, java.util.Map<java.lang.String,java.lang.Object>>(this, "docValues", "docValues", java.util.Map.class);
    ...
    private static final JEDocMeta singleton = new JEDocMeta();
    ...
    public com.jsonengine.model.JEDoc entityToModel(com.google.appengine.api.datastore.Entity entity) {
        ...
        model.setIndexEntries(toSet(java.lang.String.class, entity.getProperty("indexEntries")));
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(com.jsonengine.model.JEDoc) is not defined.");
    }
    ...
    @Override
    protected void prePut(com.google.appengine.api.datastore.Entity entity) {
    }

    @Override
    protected void preDelete(com.google.appengine.api.datastore.Key key) {
    }
