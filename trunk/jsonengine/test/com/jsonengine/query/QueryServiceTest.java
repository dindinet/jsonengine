...
public class QueryServiceTest extends AppEngineTestCase {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void queryWith3EQs() throws JEConflictException, JENotFoundException {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void queryWithSortAsc() throws JEConflictException, JENotFoundException {
        ...
        final QueryFilter sortFilter =
            new QueryFilter.SortFilter(qr.getDocType(), "id", QueryFilter.SortOrder.ASC);
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void queryWithSortDesc() throws JEConflictException, JENotFoundException {
        ...
        final QueryRequest qr = JETestUtils.i.createTestQueryRequest();
        final QueryFilter sortFilter =
            new QueryFilter.SortFilter(qr.getDocType(), "weight", QueryFilter.SortOrder.DESC);
        qr.addQueryFilter(sortFilter);
